...
def chat(payload: Dict[str, Any]):
    ...
    # ================= RU =================
        ...
        "- Экономный — $650 / неделя (2800 миль / месяц)\n"
        "- Стандартный — $675 / неделя (3800 миль / месяц)\n"
        "- Интенсивный — $700 / неделя (4800 миль / месяц)\n"
        "- Экстрим — $725 / неделя (5800 миль / месяц)\n"
        "- Double Shift — $950 / неделя (безлимит, работа вдвоем)\n\n"
        ...
        "- Economy — $650 / week (2800 miles / month)\n"
